...
export const MICE: Mouse[] = [
    ...
    },
    {
        ...
        osTypes: [OS_TYPES.WINDOWS10, OS_TYPES.WINDOWS11],
        software: SOFTWARE.ARMOURY_CRATE,
        batteryType: BATTERY_TYPES.LI_ION,
        batteryCapacity: 800,
        batteryLife: 3600
    },
    {
        name: 'MX Master 3S',
        images: ['mx_master_3s.webp'],
        imagesByColor: {
            [COLORS.BLACK]: 'mx_master_3s_black.webp',
            [COLORS.GRAPHITE]: 'mx_master_3s_graphite.webp',
            [COLORS.PALE_GREY]: 'mx_master_3s_pale_grey.webp',
        },
        brand: BRANDS.LOGITECH,
        line: LINES.MASTER_SERIES,
        colors: [COLORS.BLACK, COLORS.GRAPHITE, COLORS.PALE_GREY],
        wired: true,
        wireless: true,
        bluetoothVersion: 5.1,
        radioFrequency: 2.4,
    ...
    {
        name: 'MX Vertical',
        images: ['mx_vertical.webp'],
        imagesByColor: {
            [COLORS.GRAPHITE]: 'mx_vertical.webp',
        },
        brand: BRANDS.LOGITECH,
        colors: [COLORS.GRAPHITE],
        wired: true,
        wireless: true,
